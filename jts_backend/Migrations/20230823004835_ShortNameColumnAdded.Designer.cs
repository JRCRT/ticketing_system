...
namespace jts_backend.Migrations
{
    ...
    [Migration("20230823004835_ShortNameColumnAdded")]
    partial class ShortNameColumnAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("jts_backend.Models.TicketModel", b =>
                {
                    b.HasOne("jts_backend.Models.UserModel", "created_by")
                        .WithMany()
                    ...
                    b.HasOne("jts_backend.Models.UserModel", "received_by")
                        .WithMany()
